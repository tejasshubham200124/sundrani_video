...
const MainChild = (props) => {
    const [video_type, setVideo_type] = useState();
    const [topicName, setTopicName] = useState(props.channel?.video_name || '');
    const [topicDesc, setTopicDesc] = useState(props.channel?.video_desc || '');
    const [videoStatus, setVideoStatus] = useState(props.channel?.video_status || '');
    ...
    const VideoDetails = () => {
        ...
        return (
            <div className='video mt-4'>
                <PlyrPlayer
                    src={`https://sarsundrani.s3.ap-south-1.amazonaws.com/${props.channel?.video_file}`}
                    alt={props.channel?.video_file}
                    options={options}
                    className='video'
                />
            </div>
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedVideo = {
          ...
          video_type: props.channel?.video_type || '',
          video_price: props.channel?.video_price || '',
          video_status: videoStatus,
          active_days: props.channel?.active_days || '',
          topic_name: topicName,
          topic_desc: topicDesc,
          video_file: props.channel?.video_file || '',
          image: props.channel?.video_image || '',
        };
      
        try {
          const response = await fetch('https://apidev.sundranifilms.co.in/admin/update_main_video_details', {
            method: 'POST',
            headers: {
        ...
        <div>
            ...
            >
                    ...
                    <form>
                        <div className='mt-1'>
                            ...
                            <input
                                ...
                                defaultValue={props.channel?.video_name || ''}
                            />
                        </div>
                        <div className="form-group mt-1">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                    defaultValue={props.channel?.video_desc || ''}
                            ...
                            <div className="col-md-6">
                                <div className="form-group mt-1">
                                    ...
                                    <Form.Select
                                        ...
                                        defaultValue={props.channel?.video_status || ''}
                                    >
                            ...
                            <div className="col-md-6">
                                <div className="form-group mt-1">
                                    ...
                                    <Form.Select
                                        aria-label="Default select example"
                                        name="video_type"
                                        defaultValue={props.channel?.video_type || ''}
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-6 category-video-img2'>
                                <img src={`https://sarsundrani.s3.ap-south-1.amazonaws.com/${props.channel?.video_image}`} />
                            </div>
                        </div>
                ...
                <Modal.Footer>
                    ...
                    <input type="submit" onClick={handleSubmit} name="submit" className="btn btn-success" />
                </Modal.Footer>
            </Modal>
        </div>
    )
